...
public class Interlace3dsOtpSubscriber(IEventBusService eventBusService, IServiceProvider serviceProvider) : IHostedService
{
    public async Task StartAsync(CancellationToken cancellationToken)
    {
        await eventBusService.SubscribeAsync<MessageEnvelope<Interlace3dOtpEvent>, object>(EventTopics.NotificationEvents.Subscriptions.Card3dOtp, async (eventData) =>
        {
            ...
            {
                Message = $"Your OTP is {eventData.Data.Otp}",
